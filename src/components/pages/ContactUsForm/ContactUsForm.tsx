const ContactUsForm = () => {
  return (
    <div className="bg-[#F8F8F8] rounded-xl shadow-md max-w-[856px] mx-auto">
      <form className="grid grid-cols-1 sm:grid-cols-2 gap-9 md:p-16 p-3">
        {/* First Name */}
        <div>
          <label
            htmlFor="firstName"
            className="block text-lg md:text-[22px] font-semibold text-black"
          >
            First Name *
          </label>
          <input

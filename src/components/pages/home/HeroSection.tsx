...
export default function HeroSection() {
  return (
    <section className="bg-customGradient relative overflow-hidden">
      ...
      {/* Content */}
      <div className="relative container md:py-[140px]">
        <div className="flex">
          {/* Left Content */}
          <div className="text-center lg:text-left">
            ...
            {/* Main Heading */}
            <h2 className="font-light text-2xl tracking-[-0.02em] md:text-left text-center uppercase md:text-[92px] md:leading-[103px] text-white my-[52px]">
              <span className="font-bold">our </span>Creative digital{" "}
              <span className="font-bold">agency.</span>
            </h2>

            {/* Welcome Text */}
            <p className="text-white/60 max-w-[732px] font-bold font-satoshi text-sm sm:text-base lg:text-lg">

...
export default function ServiceDetails() {
  ...
  return (
    <div className="container">
      <div className="lg:mt-[140px] sm:mt-[70px] mt-[50px] flex flex-col lg:flex-row gap-[60px]">
        {/* Sidebar Navigation */}

        <div className="space-y-2 lg:flex-none xl:w-[357px] lg:w-[300px]">
        ...
        <div className="w-full flex-1">
          ...
          <div className="mb-8">
            {/* Text Section */}
            <h1 className="text-xl md:text-2xl font-satoshi font-bold text-black leading-relaxed">
              We believe exceptional design is at the heart of every successful
              digital experience. Our UI/UX design services focus on creating
              user-centered interfaces that are not only visually stunning but
            ...
            <div className="relative rounded-lg mt-7 sm:mt-10 overflow-hidden">
              <Image
                src={image}
                alt="Craftwork"
                className="w-full max-w-[879px] h-auto"
              />
            </div>
          </div>
          ...
          <section className="mb-16">
            ...
            <p className="text-sm sm:text-base text-black-secondary font-satoshi font-medium leading-relaxed mb-8">
              At Vyazen, we believe exceptional design is at the heart of every
              successful digital experience. Our UI/UX design services focus on
              creating user-centered interfaces that are not only visually
              stunning but also intuitive and functional. By combining
              creativity with strategy, we craft seamless experiences that
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
              ...
              {Array(4)
                ...
                .map((item, idx) => (
                  ...
                  >
                    <div className="bg-yellow-primary w-16 lg:w-20 h-16 lg:h-20 rounded-full flex items-center justify-center mb-6">
                      <LiaAwardSolid className="w-8 lg:w-10 h-8 lg:h-10 " />
                    </div>
          ...
          <section>
            <div className="text-lg sm:text-xl md:text-4xl  max-w-lg mb-4 sm:mb-8">
              <h2>
                <span className="font-semibold">Why</span> You Should Choose Our
                UX/UI <span className="font-semibold">Service.</span>
              </h2>
            </div>

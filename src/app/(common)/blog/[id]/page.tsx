       ...
       <div className="flex-1 w-full  ">
          ...
          <div className="prose max-w-none  mb-8">
            <p className="text-gray-600 text-base leading-relaxed">
              ...
              professionals eager to contribute.
            </p>
            <p className="text-gray-600 text-base leading-relaxed mt-4">
              Creating a thriving work culture in a young office revolves around
              openness, growth, and purpose. Embracing flexibility, such as
              remote work options and adaptable hours, respects individual needs
              and fosters loyalty.
            </p>
          </div>
          ...
          <div className="md:max-w-screen-lg mx-auto my-8">
            ...
            <div className="flex items-center space-x-4 mt-4">
             ...
             {/* Comments Section */}
          <div className="mt-12">
            <h2 className="md:text-[32px] text-xl font-semibold mb-6">2 Comments</h2>
          ...
          <form className="mt-12">
            <h2 className="md:text-[32px] text-xl  font-semibold mb-6">Leave a Comment</h2>
